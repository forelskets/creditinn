...
import { AllBankOffer, getTransactionList, saveBankOffer } from '../_services/Admin.services';
    ...
    <Page title="Transaction | CreditIN">
      <Container>
        <div style={{ display: 'flex' }}>
          ...
          <Button variant="contained" onClick={() => setTransaction(realData)}>
            Refresh
          </Button>
        </div>
        ...
        <MaterialTable
          ...
          options={{
            ...
            pageSizeOptions: [10, 15, 20, 35, 50, transaction?.length]
          }}
        />
      </Container>
    </Page>
