...
import { TokenHead, TokenToolbar, TokenMenu } from '../components/_dashboard/Token';
//
import STAFFLIST from '../_mocks_/staff';

// ----------------------------------------------------------------------

const TABLE_HEAD = [
  { id: 'name', label: 'Name', alignRight: false },
  { id: 'tokenno', label: 'TokenNo', alignRight: false },
  { id: 'emailid', label: 'EmailId', alignRight: false },
  { id: 'mobileno', label: 'MobileNo', alignRight: false },
  { id: 'Openedby', label: 'OpenBy', alignRight: false },
