...
const LoanForm = () => {
  ...
  const Profession = [
    { value: 'Salried', label: 'Self Employed' , status:'Salried'  },
    { value: 'BussinessMan', label: 'Bussiness' , status:'Bussiness' },
    { value: 'SelfEmployed', label: 'Salried' , status:'Salried'},
  ];
       ...
       <div className="form-row my-3 row">
                      <div className="form-group col-md-6">
                        ...
                        <input
                          ...
                          id="lyst"
                          name="lyst"
                          placeholder="Current Year Turn Over"
                          value={lyst}
                ...
                <div className="tab-pane fade" id="step2">
                  <div className="form-2">
                    <div className="form-row row my-3">
                      <div className="form-group col-md-6">
                        <label>
                          {(professionLabel === 'Salried') ? "Employer": "Firm Name"}
                          <i
                            data-bs-toggle="tooltip"
                            data-bs-placement="top"
                      ...
                      <div className="form-group col-md-6">
                        <label>
                        {(professionLabel === 'Salried') ? "Total Work": "Business Experience"}
                          <i
                            data-bs-toggle="tooltip"
                            data-bs-placement="top"
                    ...
                    <div className="form-row my-3 row">
                      <div className="form-group col-md-6">
                        <label>
                        {(professionLabel === 'Salried') ? "MonthlyIncome": "Curr. Yr. TurnOver"}
                          <i
                            data-bs-toggle="tooltip"
                            data-bs-placement="top"
                            title="for eg:13000"
